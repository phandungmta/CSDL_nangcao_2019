...
GO 
CREATE PROCEDURE [gen_DT_Council_insert](  @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @Councilcode varchar(10),   @teachercode Varchar(10),   @councilrolecode Varchar(10),   @semester smallint,   @time date,   @workloadpart int,   @yearstart int)
AS 
BEGIN
	INSERT INTO [DT_Council]([code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [Councilcode], [teachercode], [councilrolecode], [semester], [time], [workloadpart], [yearstart]) VALUES(@code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @Councilcode, @teachercode, @councilrolecode, @semester, @time, @workloadpart, @yearstart)
END
...
GO 
CREATE PROCEDURE [gen_DT_Council_update](@code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @Councilcode varchar(10), @teachercode Varchar(10), @councilrolecode Varchar(10), @semester smallint, @time date, @workloadpart int, @yearstart int, @Key_code Varchar(10))
AS 
BEGIN
	UPDATE [DT_Council] SET [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [Councilcode] =@Councilcode, [teachercode] =@teachercode, [councilrolecode] =@councilrolecode, [semester] =@semester, [time] =@time, [workloadpart] =@workloadpart, [yearstart] =@yearstart WHERE [code] =@Key_code
END
...
-----------------begin EDULEVEL_insert--------------------
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'gen_EDULEVEL_insert')
    DROP PROCEDURE [gen_EDULEVEL_insert]
GO 
CREATE PROCEDURE [gen_EDULEVEL_insert](  @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int)
AS 
BEGIN
	INSERT INTO [EDULEVEL]([code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder]) VALUES(@code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder)
END
-----------------end EDULEVEL_insert--------------------
GO

-----------------begin EDULEVEL_update--------------------
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'gen_EDULEVEL_update')
    DROP PROCEDURE [gen_EDULEVEL_update]
GO 
CREATE PROCEDURE [gen_EDULEVEL_update](@code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @Key_code Varchar(10))
AS 
BEGIN
	UPDATE [EDULEVEL] SET [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder WHERE [code] =@Key_code
END
-----------------end EDULEVEL_update--------------------
GO

-----------------begin EDULEVEL_delete--------------------
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'gen_EDULEVEL_delete')
    DROP PROCEDURE [gen_EDULEVEL_delete]
GO 
CREATE PROCEDURE [gen_EDULEVEL_delete](  @code Varchar(10))
AS 
BEGIN
	DELETE FROM [EDULEVEL] WHERE [code] =@code
END
-----------------end EDULEVEL_delete--------------------
GO
...
GO 
CREATE PROCEDURE [gen_ACADEMIC_RANK_insert](  @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @quotahour int,   @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @Researchtitlecode varchar(10),   @teachercode varchar(10),   @place Nvarchar(1000),   @time date)
AS 
BEGIN
	INSERT INTO [ACADEMIC_RANK]([code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [quotahour], [code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [Researchtitlecode], [teachercode], [place], [time]) VALUES(@code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @quotahour, @code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @Researchtitlecode, @teachercode, @place, @time)
END
...
GO 
CREATE PROCEDURE [gen_ACADEMIC_RANK_update](@code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @quotahour int, @code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @Researchtitlecode varchar(10), @teachercode varchar(10), @place Nvarchar(1000), @time date, @Key_code Varchar(10), @Key_code Varchar(10))
AS 
BEGIN
	UPDATE [ACADEMIC_RANK] SET [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [quotahour] =@quotahour, [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [Researchtitlecode] =@Researchtitlecode, [teachercode] =@teachercode, [place] =@place, [time] =@time WHERE [code] =@Key_code AND [code] =@Key_code
END
...
GO 
CREATE PROCEDURE [gen_ACADEMIC_RANK_delete](  @code Varchar(10),   @code Varchar(10))
AS 
BEGIN
	DELETE FROM [ACADEMIC_RANK] WHERE [code] =@code AND [code] =@code
END
...
GO 
CREATE PROCEDURE [gen_BOOK_HISTORY_insert](  @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @teachercode varchar(10),   @teachername Nvarchar(200),   @booktypename Nvarchar(200),   @bookname Nvarchar(200),   @amountofauthor int,   @amountoftime date)
AS 
BEGIN
	INSERT INTO [BOOK_HISTORY]([code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [teachercode], [teachername], [booktypename], [bookname], [amountofauthor], [amountoftime]) VALUES(@code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @teachercode, @teachername, @booktypename, @bookname, @amountofauthor, @amountoftime)
END
...
GO 
CREATE PROCEDURE [gen_BOOK_HISTORY_update](@code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @teachercode varchar(10), @teachername Nvarchar(200), @booktypename Nvarchar(200), @bookname Nvarchar(200), @amountofauthor int, @amountoftime date, @Key_code Varchar(10))
AS 
BEGIN
	UPDATE [BOOK_HISTORY] SET [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [teachercode] =@teachercode, [teachername] =@teachername, [booktypename] =@booktypename, [bookname] =@bookname, [amountofauthor] =@amountofauthor, [amountoftime] =@amountoftime WHERE [code] =@Key_code
END
...
GO 
CREATE PROCEDURE [gen_RESEARCH_HISTORY_insert](  @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @teachercode varchar(10),   @teachername Nvarchar(200),   @researchtypename Nvarchar(200),   @researchrolename Nvarchar(200),   @amountofauthor int,   @amountoftime date,   @workloadname Nvarchar(200),   @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @teachercode varchar(10),   @teachername Nvarchar(200),   @postname Nvarchar(200),   @place Nvarchar(200),   @tenure int,   @start date,   @end date)
AS 
BEGIN
	INSERT INTO [RESEARCH_HISTORY]([code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [teachercode], [teachername], [researchtypename], [researchrolename], [amountofauthor], [amountoftime], [workloadname], [code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [teachercode], [teachername], [postname], [place], [tenure], [start], [end]) VALUES(@code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @teachercode, @teachername, @researchtypename, @researchrolename, @amountofauthor, @amountoftime, @workloadname, @code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @teachercode, @teachername, @postname, @place, @tenure, @start, @end)
END
...
GO 
CREATE PROCEDURE [gen_RESEARCH_HISTORY_update](@code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @teachercode varchar(10), @teachername Nvarchar(200), @researchtypename Nvarchar(200), @researchrolename Nvarchar(200), @amountofauthor int, @amountoftime date, @workloadname Nvarchar(200), @code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @teachercode varchar(10), @teachername Nvarchar(200), @postname Nvarchar(200), @place Nvarchar(200), @tenure int, @start date, @end date, @Key_code Varchar(10), @Key_code Varchar(10))
AS 
BEGIN
	UPDATE [RESEARCH_HISTORY] SET [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [teachercode] =@teachercode, [teachername] =@teachername, [researchtypename] =@researchtypename, [researchrolename] =@researchrolename, [amountofauthor] =@amountofauthor, [amountoftime] =@amountoftime, [workloadname] =@workloadname, [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [teachercode] =@teachercode, [teachername] =@teachername, [postname] =@postname, [place] =@place, [tenure] =@tenure, [start] =@start, [end] =@end WHERE [code] =@Key_code AND [code] =@Key_code
END
...
GO 
CREATE PROCEDURE [gen_MENTORING_HISTORY_insert](  @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @teachercode varchar(10),   @teachername Nvarchar(200),   @mentoringtypename Nvarchar(200),   @studentname Nvarchar(200),   @classname Nvarchar(200),   @amountoftime Nvarchar(200),   @standardquantity int,   @edubranchname Nvarchar(200),   @thesisname Nvarchar(200))
AS 
BEGIN
	INSERT INTO [MENTORING_HISTORY]([code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [teachercode], [teachername], [mentoringtypename], [studentname], [classname], [amountoftime], [standardquantity], [edubranchname], [thesisname]) VALUES(@code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @teachercode, @teachername, @mentoringtypename, @studentname, @classname, @amountoftime, @standardquantity, @edubranchname, @thesisname)
END
...
GO 
CREATE PROCEDURE [gen_MENTORING_HISTORY_update](@code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @teachercode varchar(10), @teachername Nvarchar(200), @mentoringtypename Nvarchar(200), @studentname Nvarchar(200), @classname Nvarchar(200), @amountoftime Nvarchar(200), @standardquantity int, @edubranchname Nvarchar(200), @thesisname Nvarchar(200), @Key_code Varchar(10))
AS 
BEGIN
	UPDATE [MENTORING_HISTORY] SET [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [teachercode] =@teachercode, [teachername] =@teachername, [mentoringtypename] =@mentoringtypename, [studentname] =@studentname, [classname] =@classname, [amountoftime] =@amountoftime, [standardquantity] =@standardquantity, [edubranchname] =@edubranchname, [thesisname] =@thesisname WHERE [code] =@Key_code
END
...
GO 
CREATE PROCEDURE [gen_TEACHER_HISTORY_insert](  @code Varchar(10),   @codeview Varchar(20),   @name Nvarchar(200),   @note Nvarchar(200),   @lastedituser Varchar(20),   @lastedittime Datetime,   @lock smallint,   @lockdate datetime,   @theorder int,   @teachercode varchar(10),   @teachername Nvarchar(200),   @departmentname Nvarchar(200),   @facultyname Nvarchar(200),   @start date,   @end date)
AS 
BEGIN
	INSERT INTO [TEACHER_HISTORY]([code], [codeview], [name], [note], [lastedituser], [lastedittime], [lock], [lockdate], [theorder], [teachercode], [teachername], [departmentname], [facultyname], [start], [end]) VALUES(@code, @codeview, @name, @note, @lastedituser, @lastedittime, @lock, @lockdate, @theorder, @teachercode, @teachername, @departmentname, @facultyname, @start, @end)
END
...
GO 
CREATE PROCEDURE [gen_TEACHER_HISTORY_update](@code Varchar(10), @codeview Varchar(20), @name Nvarchar(200), @note Nvarchar(200), @lastedituser Varchar(20), @lastedittime Datetime, @lock smallint, @lockdate datetime, @theorder int, @teachercode varchar(10), @teachername Nvarchar(200), @departmentname Nvarchar(200), @facultyname Nvarchar(200), @start date, @end date, @Key_code Varchar(10))
AS 
BEGIN
	UPDATE [TEACHER_HISTORY] SET [code] =@code, [codeview] =@codeview, [name] =@name, [note] =@note, [lastedituser] =@lastedituser, [lastedittime] =@lastedittime, [lock] =@lock, [lockdate] =@lockdate, [theorder] =@theorder, [teachercode] =@teachercode, [teachername] =@teachername, [departmentname] =@departmentname, [facultyname] =@facultyname, [start] =@start, [end] =@end WHERE [code] =@Key_code
END
